...
void init(GLFWwindow* window) {
	...
	moonTexture = Utils::loadTexture("brickwall.jpg");
	moonNormalMap = Utils::loadTexture("brickwall-normal.jpg");
}
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(800, 600, "Pregunta - 1", NULL, NULL);
