...
float rotAmt = 0.0f, incTras = 0.0f, tras=0.0f;
...
void display(GLFWwindow* window, double currentTime) {
    ...
    mMat = glm::translate(mMat, glm::vec3(tras,0.0f , 0.0f));
	mMat = glm::rotate(mMat, rotAmt, glm::vec3(0.0f, 0.0f,1.0f));
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "Problema 2", NULL, NULL);
