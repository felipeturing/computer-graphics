...
void display(GLFWwindow* window, double currentTime) {
	...
	if (cameraZ > 0.75f) transDir = -0.05f;
	if (cameraZ < 0.29f) transDir = 0.05f;

	mMat = glm::translate(glm::mat4(1.0f), glm::vec3(terLocX, terLocY, terLocZ));
	mMat = glm::rotate(mMat, toRadians(19.0f), glm::vec3(1.0f, 0.0f, 0.0f));
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "Problema 3", NULL, NULL);
