...
void display(GLFWwindow *window, double currentTime) {
	...
	glDrawArraysInstanced(GL_TRIANGLES, 0, 36, 24); // en realidad es como si estuviera pasando 24*36 vertices, de los cuales cada 36 forman una instancia
// y en cada instancia cada tres es un triangulo
}
